...
function(a) {
    ...
    a.ThreeSixty = function(b, c) {
        ...
        e.loadImages = function() {
            ...
            h = d.zeroBased ? 0 : 1,
            c = d.imgArray ? d.imgArray[d.loadedImages] : d.imageslist[(e.zeroPad(d.loadedImages + h)-1)]+ (e.browser.isIE() ? "?" + (new Date).getTime() : ""),
        ...
        e.play_stop = function(b) {
            b.preventDefault(),
            d.autoplay ? (d.autoplay = !1, a(b.currentTarget).removeClass("nav_bar_stop").addClass("nav_bar_play"), clearInterval(d.play), d.play = null) : (d.autoplay = !0, d.play = setInterval(e.moveToNextFrame, d.playSpeed), a(b.currentTarget).removeClass("nav_bar_play").addClass("nav_bar_stop"))
        },
        e.next = function(a) {
            a && a.preventDefault(),
            d.endFrame -= 5,
        ...
        e.initEvents = function() {
            ...
            function() {
                d.dragging = !1
                //,a(this).css("cursor", "url(assets/pointer.png)")
            }),
            ...
            function(a) {
                d.dragging ? (a.preventDefault(), !e.browser.isIE && d.showCursor/* && e.$el.css("cursor", "url(assets/pointer.png), auto")*/) : !e.browser.isIE && d.showCursor/* && e.$el.css("cursor", "url(assets/pointer.png), auto")*/,
                e.trackPointer(a)
            }),
        ...
        e.getNormalizedCurrentFrame = function() {
            var a, b;
            return d.disableWrap ? (a = Math.min(d.currentFrame, d.totalFrames - (d.zeroBased ? 1 : 0)), b = Math.min(d.endFrame, d.totalFrames - (d.zeroBased ? 1 : 0)), a = Math.max(a, d.zeroBased ? 0 : 1), b = Math.max(b, d.zeroBased ? 0 : 1), d.currentFrame = a, d.endFrame = b) : (a = Math.ceil(d.currentFrame % d.totalFrames), 0 > a && (a += d.totalFrames - (d.zeroBased ? 1 : 0))),
            a
        },
